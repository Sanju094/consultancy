...
export default function UpdateProduct() {
    ...
    const categoriesWithTypes = {
        'Gold': ['Ring', 'Earring', 'Bracelet', 'Bangle', 'Chain', 'Mangalyam', 'Necklace', 'Haram (Gold)', 'Antique (in subdivision)'],
                        ...
                        <form onSubmit={submitHandler} className="shadow-lg" encType='multipart/form-data'>
                            ...
                            <div className="form-group">
                                ...
                                <select value={category} onChange={e => setCategory(e.target.value)} className="form-control" id="category_field">
                                    ...
                                    {Object.keys(categoriesWithTypes).map(category => (
                            ...
                            {category && (
                                <div className="form-group">
                                    ...
                                    <select value={type} onChange={e => setType(e.target.value)} className="form-control" id="type_field">
                                        <option value="">Select</option>
                                        {categoriesWithTypes[category].map(type => (
